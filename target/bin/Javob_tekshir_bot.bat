...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="Javob_tekshir_bot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" org.Ali.Main %CMD_LINE_ARGS%
